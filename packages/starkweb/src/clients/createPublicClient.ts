...
/**
 * Creates a Public Client with a given [Transport](https://starkweb.xyz/docs/clients/intro) configured for a [Chain](https://starkweb.xyz/docs/clients/chains).
 *
 * - Docs: https://starkweb.xyz/docs/clients/public
 *

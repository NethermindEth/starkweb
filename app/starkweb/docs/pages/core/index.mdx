...
- Built-in support for popular wallets via [Connectors](#TODO:/core/connectors/injected)
...
- [**Configuration**](#TODO:/core/configuration/createConfig) - Learn how to configure StarkWeb for your app
- [**Actions**](/core/actions/getAccount) - Browse the collection of actions and learn how to use them
- [**Connectors**](#TODO:/core/connectors/injected) - Learn about different wallet connection options

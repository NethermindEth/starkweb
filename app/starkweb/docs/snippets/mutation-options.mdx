...
:::info
Wolf does not support passing all TanStack Query parameters. TanStack Query parameters, like `mutationFn` and `mutationKey`, are used internally to make Wolf work and you cannot override them. All parameters listed below are supported.
:::

...
<code className="vocs_Code">{props.TData}</code>
</p>
...
<p className="vocs_Paragraph">
<code className="vocs_Code">null | {props.TError}</code>
</p>
...
<p className="vocs_Paragraph">
<code className="vocs_Code">(options: \{ cancelRefetch?: boolean | undefined; throwOnError?: boolean | undefined \}) => Promise\<UseQueryResult\<{props.TData}, {props.TError}\>\></code>
</p>

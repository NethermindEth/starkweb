...
:::info
Wolf does not support passing all TanStack Query parameters. TanStack Query parameters, like `queryFn` and `queryKey`, are used internally to make Wolf work and you cannot override them. All parameters listed below are supported.
:::

...
console.log(result1)
// const convertedValues = result1.map(v => BigInt(v));
// const decoded3 = decodeCallResult(convertedValues, [{ type: 'Uint256' }])
...
// const convertedResult = result.map((v: string) => new BigNumber(v));
// const decoded = decodeCallResult(convertedResult, exampleAbi[0].outputs);
...
// '2'             // Second token ID
// ];
// const convertedComplexResult = complexResult.map((v: string) => new BigNumber(v));
// const decodedComplex = decodeCallResult(convertedComplexResult, complexAbi[0].outputs);
...
// const values1 = [
//   1n,          // bool: true
//   100n,        // U256 low 128 bits
//   200n,        // U256 high 128 bits
//   0x123abc     // felt
// ];
// const convertedValues1 = values1.map((v: BigInt) => v);
// const decoded1 = decodeFromTypes(typesExample, convertedValues1);
...
// ];
// const convertedValues2 = values2.map((v: BigNumber) => v);
// const decoded2 = decodeFromParams(paramsExample as AbiParameter[], convertedValues2);
